    ...
    fun sign_In_Title_Displayed_By_Default() {
        ...
        composeTestRule
            .onNodeWithText(
                ...
                // source set.
                // Be sure to confirm that R is from emperorfin.android.composeemailauthentication.test.R
//                InstrumentationRegistry.getInstrumentation().context.getString(R.string.label_sign_in_to_account)
                ...
                // Be sure to confirm that R is from emperorfin.android.composeemailauthentication.R
...
//                    error = R.string.test_error_message
     ...
     * function in app/src/main/java/emperorfin/android/composeemailauthentication/ui/screens/authentication/stateholders/AuthenticationViewModel.kt
