...
import emperorfin.android.militaryjet.ui.utils.AuthenticationTitleTestUtil2
...
/**
 * [AuthenticationTitleTest5] class is a revision of this class.
 *
 * Notes:
 *
 ...
 */
class AuthenticationTitleTest4 {
    ...
    private lateinit var authenticationTitleTestUtil: AuthenticationTitleTestUtil2
...
//        mTargetContext = ApplicationProvider.getApplicationContext<Context>() // Haven't tested but might work.
        ...
        authenticationTitleTestUtil = AuthenticationTitleTestUtil2(
            mContext = mContext,
