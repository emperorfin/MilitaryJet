...
/**
 * This class is a clean version of [AuthenticationToggleModeTest2] class and a cleaner version of
 * [AuthenticationToggleModeTest] class.
 *
 * Notes:
 *
...
//        mTargetContext = ApplicationProvider.getApplicationContext<Context>() // Haven't tested but might work.
    ...
    fun need_Account_Action_Displayed() {
        ...
        authenticationToggleModeTestUtil
