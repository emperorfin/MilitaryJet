...
//        mTargetContext = ApplicationProvider.getApplicationContext<Context>() // Haven't tested but might work.
    ...
    fun sign_Up_Title_Displayed() {
        ...
        composeTestRule
            .onNode(
                matcher = hasText(
                    text = mContext.getString(R.string.label_sign_up_for_account),
                    substring = FALSE,
                    ignoreCase = FALSE
                )
            )
