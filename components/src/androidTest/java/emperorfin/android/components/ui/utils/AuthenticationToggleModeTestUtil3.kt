...
import emperorfin.android.components.ui.screens.authentication.uicomponents.AuthenticationToggleMode
...
class AuthenticationToggleModeTestUtil3(
    ...
    fun onNodeWithAuthenticationToggleModeAnd(
        composeTestRule: ComposeContentTestRule = this.composeTestRule,
        useUnmergedTree: Boolean = FALSE,
    ...
    fun hasTestTagAuthenticationToggleMode(): SemanticsMatcher {
    ...
    fun hasTestTagsAuthenticationToggleModeAnd(otherTestTag: String): SemanticsMatcher {
    ...
    fun hasTextExactlyNeedAnAccount(): SemanticsMatcher {
    ...
    fun hasTextExactlyAlreadyHaveAnAccount(): SemanticsMatcher {
