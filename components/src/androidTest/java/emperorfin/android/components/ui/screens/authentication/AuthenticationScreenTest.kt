...
import emperorfin.android.components.ui.extensions.waitUntilDoesNotExist
import emperorfin.android.components.ui.extensions.waitUntilExists
...
import emperorfin.android.components.ui.screens.authentication.uicomponents.tags.Tags
...
import emperorfin.android.components.ui.utils.KeyboardHelper
...
class AuthenticationScreenTest {
    ...
    companion object {
        ...
        /**
         * Since the delay time millis in the authenticate() function in app/src/main/java/emperorfin/android/components/ui/screens/authentication/stateholders/AuthenticationViewModel.kt
...
//        mTargetContext = ApplicationProvider.getApplicationContext<Context>() // Haven't tested but might work.
    ...
    /**
     * For this test case to pass, call "semantics(mergeDescendants = true){}" (without quotes) on
     * the Modifier object passed in as the modifier argument to the Box composable in
     * app/src/main/java/emperorfin/android/components/ui/screens/authentication/uicomponents/AuthenticationContent.kt
     * Because merging descendant semantics is, in my opinion, not recommended, please see
     * [sign_In_Mode_Displayed_By_Default_2]
     */
    @Test
    ...
    @Test
    fun sign_In_Mode_Displayed_By_Default_2() {
     ...
     * app/src/main/java/emperorfin/android/components/ui/screens/authentication/uicomponents/AuthenticationContent.kt
     * Because merging descendant semantics is, in my opinion, not recommended, please see
     * [sign_Up_Mode_Displayed_After_Toggled_2]
     */
    @Test
    ...
    @Test
    fun sign_Up_Mode_Displayed_After_Toggled_2() {
    ...
    fun sign_In_Title_Displayed_By_Default() {
        ...
        composeTestRule
            .onNodeWithText(
                ...
                // source set.
                // Be sure to confirm that R is from emperorfin.android.components.test.R
//                InstrumentationRegistry.getInstrumentation().context.getString(R.string.label_sign_in_to_account)
                ...
                // Be sure to confirm that R is from emperorfin.android.components.R
//                InstrumentationRegistry.getInstrumentation().targetContext.getString(R.string.label_sign_in_to_account)
     ...
     * authenticate() function in app/src/main/java/emperorfin/android/components/ui/screens/authentication/stateholders/AuthenticationViewModel.kt,
...
//                    error = R.string.test_error_message
     ...
     * app/src/main/java/emperorfin/android/components/ui/screens/authentication/uicomponents/AuthenticationContent.kt
     * Because merging descendant semantics is, in my opinion, not recommended, please see
     * [sign_Up_Progress_Indicator_Not_Displayed_By_Default_4]
     */
    @Test
    ...
    @Test
    fun sign_Up_Progress_Indicator_Not_Displayed_By_Default_4() {
     ...
     * app/src/main/java/emperorfin/android/components/ui/screens/authentication/stateholders/AuthenticationViewModel.kt
     ...
     * the previous test, we can perform the authentication flow, followed by performing the
     ...
     * function in app/src/main/java/emperorfin/android/components/ui/screens/authentication/stateholders/AuthenticationViewModel.kt
...
//        Espresso.pressBack()
    ...
    /**
     * This test case used to pass in a previous commit ( 49b3e8f10c345a254f3d28a669216903501f2716 )
     ...
     * before the update of most of this project's dependencies such as libraries and plugins.
     * If it fails, please use this revised test case
     * [sign_In_Password_Input_Soft_Keyboard_Shown_When_Next_Ime_Action_Clicked_From_Email_Input_4]
     */
    @Test
    ...
    @Test
    fun sign_In_Password_Input_Soft_Keyboard_Shown_When_Next_Ime_Action_Clicked_From_Email_Input_4() {
     ...
     * before the update of most of this project's dependencies such as libraries and plugins.
     * If it fails, please use this revised test case
     * [sign_Up_Password_Input_Soft_Keyboard_Shown_When_Next_Ime_Action_Clicked_From_Email_Input_4]
     */
    @Test
    ...
    @Test
    fun sign_Up_Password_Input_Soft_Keyboard_Shown_When_Next_Ime_Action_Clicked_From_Email_Input_4() {
