...
class AuthenticationTitleTestUtil3(
    ...
    fun onNodeWithAuthenticationTitleAnd(
        composeTestRule: ComposeContentTestRule = this.composeTestRule,
        useUnmergedTree: Boolean = FALSE,
    ...
    fun hasTestTagAuthenticationTitle(): SemanticsMatcher {
    ...
    fun hasTestTagsAuthenticationTitleAnd(otherTestTag: String): SemanticsMatcher {
    ...
    fun hasTextExactlySignInToYourAccount(): SemanticsMatcher {
    ...
    fun hasTextExactlySignUpForAnAccount(): SemanticsMatcher {
